...
$GK_ROOT_DIR = '/var/www/html/';
$GK_JAVA_CODEBASE = "/jars";
$GK_TMP_IMG_DIR = "$GK_ROOT_DIR/cgi-tmp";
# Place for frontpage images
$FRONTPAGE_IMG_DIR = "$GK_ROOT_DIR/cgi-tmp/img-fp";
$NEWS_FILE = "$GK_ROOT_DIR/cgi-tmp/news.html";
$DB_BACKUP_DIR = "$GK_ROOT_DIR/database_backups";
$GK_FETCH_SCRIPT = "/cgi-bin/instance2text.pl";
$COMPARA_DIR = "$GK_ROOT_DIR/scripts/release/orthopairs";
$ENSEMBL_API_DIR = "$GK_ROOT_DIR/cgi-modules/ensembl_api";
